...
const char* ssid     = "RFID Water Dispenser";
const char* password = "rfid 1234567890";
...
void update_account(String id, String amount) {   
    WiFiClient client;
      ...
      if (Serial.available()) {
        ...
        if(update_info != ""){
          if(update_info.indexOf("update")!=-1){
            update_account(midString( update_info, "update,", "#" ), midString( update_info, "#", "&" ));
          }
        }
      }
      return;
